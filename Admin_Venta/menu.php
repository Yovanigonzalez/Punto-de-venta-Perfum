...
?>     
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="agregar_tendencia.php" class="nav-link">
...
<li class="nav-item">
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="agregar_envase.php" class="nav-link">
        <i class="far fa-dot-circle nav-icon"></i>
        <p>Agregar</p>
      </a>
    </li>
    <li class="nav-item">
      <a href="crud_envase.php" class="nav-link">
        <i class="far fa-dot-circle nav-icon"></i>
        <p>Acciones</p>
      </a>
    </li>
...
<li class="nav-item">
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="agregar_gramo.php" class="nav-link">
        <i class="far fa-dot-circle nav-icon"></i>
        <p>Agregar</p>
      </a>
    </li>
    <li class="nav-item">
      <a href="crud_gramo.php" class="nav-link">
        <i class="far fa-dot-circle nav-icon"></i>
        <p>Acciones</p>
      </a>
    </li>
...
<li class="nav-item">
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="agregar_feremonas.php" class="nav-link">
        <i class="far fa-dot-circle nav-icon"></i>
        <p>Agregar</p>
      </a>
    </li>
...
<li class="nav-item">
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="venta_socios.php" class="nav-link">
        <i class="far fa-dot-circle nav-icon"></i>
        <p>Generar Venta</p>
      </a>
    </li>
...
<li class="nav-item">
  <a href="#" class="nav-link">
  <i class="nav-icon fas fa-box-open"></i> <!-- Clase "fas fa-box-open" para mostrar el icono de un envase vacío -->
  <p>
  Envase vacío
    <i class="right fas fa-angle-left"></i>
  </p>
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="envase.php" class="nav-link">
        <i class="far fa-dot-circle nav-icon"></i>
        <p>Agregar</p>
      </a>
    </li>
    <li class="nav-item">
      <a href="crud_envase_vacio.php" class="nav-link">
        <i class="far fa-dot-circle nav-icon"></i>
        <p>Acciones</p>
      </a>
    </li>
