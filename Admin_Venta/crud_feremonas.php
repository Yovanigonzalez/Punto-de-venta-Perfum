...
// Modify SQL queries to fetch data from the 'feromonas' table
if ($search_query) {
    $search_query = $conn->real_escape_string($search_query); // Sanitize input
    $sql_count = "SELECT COUNT(*) as total FROM feremona WHERE envase LIKE '%$search_query%' OR categoria LIKE '%$search_query'";
    $sql = "SELECT * FROM feremona WHERE envase LIKE '%$search_query%' OR categoria LIKE '%$search_query' LIMIT $offset, $registros_por_pagina";
} else {
    $sql_count = "SELECT COUNT(*) as total FROM feremona";
    $sql = "SELECT * FROM feremona LIMIT $offset, $registros_por_pagina";
}
...
<body class="hold-transition sidebar-mini">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <th>Cantidad</th>
                                        <th>Stock</th>
                                        <th>Gramos</th> <!-- Add this line for "gramos" -->
                                        <th>Categoría</th>
                                        <th>Acciones</th>
                                    </tr>
                                </thead>
                                    <tbody>
                                        <?php foreach ($feromonas as $feromona) { ?>
                                            ...
                                            <td><?php echo $feromona['stock']; ?></td>
                                            <td><?php echo $feromona['gramos']; ?></td> <!-- Add this line for "gramos" -->
                                            ...
                                            <td>
                                                            ...
                                                            <a class="btn btn-primary" href="editar_feromona.php?id=<?php echo $feromona['id']; ?>">Editar</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
    ...
    <script>
        ...
        function eliminarFeromona(id) {
            ...
            window.location.href = `eliminar_feremona.php?id=${id}`;
        }
    </script>
</body>
</html>
